...
<body>
    ...
    <div class="container">
        <h2>User Registration</h2><?php
        if (!empty($_SESSION) && isset($_SESSION['message_check_email']) && !empty($_SESSION['message_check_email'])) : ?>
                        <div class="alert alert-success text-center " id="myDiv" role="alert">
                            <?= $_SESSION['message_check_email'] ?>
                        </div>
                    <?php
                        $_SESSION['message_check_email'] = null;
                    endif;
                    ?>
